...
public class TextEditorDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAddTextDoneTextView.setOnClickListener(this);
        view.findViewById(R.id.add_text_clear_tv).setOnClickListener(this);

    }

    @Override
    public void onClick(View v) {
        if (v.getId() == R.id.add_text_done_tv) {
        ...
        } else if (v.getId() == R.id.add_text_clear_tv) {
