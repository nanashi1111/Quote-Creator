...
public class EditingToolsAdapter extends RecyclerView.Adapter<EditingToolsAdapter.ViewHolder> {
    ...
    public EditingToolsAdapter(OnItemSelected onItemSelected) {
        ...
        mToolList.add(new ToolModel("Photos", R.drawable.ic_gallery, ToolType.GALLERY));
        ...
        mToolList.add(new ToolModel("Overlay", R.drawable.ic_overlay, ToolType.OVERLAY));
        ...
        mToolList.add(new ToolModel("Border", R.drawable.ic_border, ToolType.STICKER));
        //mToolList.add(new ToolModel("Emoji", R.drawable.ic_insert_emoticon, ToolType.EMOJI));
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            vTool = itemView.findViewById(R.id.vTool);
            vTool.setOnClickListener(new View.OnClickListener() {
                @Override
