...
public class Constant {
    ...
    public static RequestOptions glideRequestOption = new RequestOptions().diskCacheStrategy(DiskCacheStrategy.ALL).priority(Priority.HIGH);

    public static int getResourceFontId(String fontCode) {
        /*try {
            return getResources().getIdentifier(fontCode, "font", getPackageName());
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }*/

        switch (Integer.parseInt(fontCode)) {
            case 1:
                return R.font.f_01;
            case 2:
                return R.font.f_02;
    ...
    public static final int SHOW_ADS_INTERVAL = 3;
    public static final int SHOW_ADS_INTERVAL_EDIT = 1;

    public static final String KEY_CATEGORY = "KEY_CATEGORY";
    public static final String KEY_PRE_TEXT = "KEY_PRE_TEXT";
    public static final String KEY_PRE_SOURCE = "KEY_PRE_SOURCE";
    ...
    public static final String KEY_SHARE_NOW = "KEY_SHARE_NOW";

    public static final String ACTION_QUOTE_VIEW_CATEGORY = "QuoteViewCate";
    public static final String ACTION_QUOTE_SELECT = "QuoteSelect";
    public static final String ACTION_QUOTE_SHARE = "QuoteShare";
    public static final String ACTION_QUOTE_CREATE = "QuoteCreate";


    public static final ArrayList<NativeAd> listNativeAds = new ArrayList<>();

    public static boolean showAds(int numberAction, long defaultValue) {
        long value = defaultValue;
        if (value == 0) {
            value = 4;
        }
        return numberAction > 0 && numberAction % value == 0;
    }

    public static boolean showAdsEdit(int numberAction) {
        LogUtils.d("NumberAction = " + numberAction + " ; showAds = " + (numberAction % SHOW_ADS_INTERVAL_EDIT == 1 && numberAction > 1));
        return numberAction > 0;
    }
    ...
    public static void clearData() {
        if (listLoveQuote != null) {
            listLoveQuote.clear();
            listLoveQuote = null;
        }
        if (listMotivationQuote != null) {
            listMotivationQuote.clear();
            listMotivationQuote = null;
        }
        if (listFamilyQuote != null) {
            listFamilyQuote.clear();
            listFamilyQuote = null;
        }
        if (listFunnyQuote != null) {
            listFunnyQuote.clear();
            listFunnyQuote = null;
        }
        if (listLifeQuote != null) {
            listLifeQuote.clear();
            listLifeQuote = null;
        }
        if (listMotherQuote != null) {
            listMotherQuote.clear();
            listMotherQuote = null;
        }
        if (listHappinessQuote != null) {
            listHappinessQuote.clear();
            listHappinessQuote = null;
        }
        if (listWomenQuote != null) {
            listWomenQuote.clear();
            listWomenQuote = null;
        }
        if (listSadQuote != null) {
            listSadQuote.clear();
            listSadQuote = null;
        }
        if (listFriendQuote != null) {
            listFriendQuote.clear();
            listFriendQuote = null;
        }
        if (listFatherQuote != null) {
            listFatherQuote.clear();
            listFatherQuote = null;
        }
        if (listPositiveQuote != null) {
            listPositiveQuote.clear();
            listPositiveQuote = null;
        }
        if (listAloneQuote != null) {
            listAloneQuote.clear();
            listAloneQuote = null;
        }
        if (listTrustQuote != null) {
            listTrustQuote.clear();
            listTrustQuote = null;
        }
    }
