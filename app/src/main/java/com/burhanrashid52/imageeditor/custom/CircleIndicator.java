package com.burhanrashid52.imageeditor.custom;
...
public class CircleIndicator extends LinearLayout {
    ...
    private void createIndicators() {
        ...
        OnClickListener indicatorClickListener = new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.getTag() instanceof String) {
                    String tagInString = (String) v.getTag();
                    int position = Integer.parseInt(tagInString.split("_")[1]);
        ...
        for (int i = 0; i < count; i++) {
            if (currentItem == i) {
                View indicator = addIndicator(orientation, mIndicatorBackgroundResId, mImmediateAnimatorOut, "indicator_" + i);
                //indicator.setOnClickListener(indicatorClickListener);
            } else {
                View indicator = addIndicator(orientation, mIndicatorUnselectedBackgroundResId,
                        mImmediateAnimatorIn, "indicator_" + i);
                //indicator.setOnClickListener(indicatorClickListener);
            }
        }
    }

    private View addIndicator(int orientation, @DrawableRes int backgroundDrawableId,
                              Animator animator, String tag) {
